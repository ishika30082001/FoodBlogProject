...
//data get jo data hum form mai fill krte hai us data ko hum object format mai convert krte hai
app.use(express.urlencoded({ extended: false })); //because hum ek form data ko handle kar rhe hai to use json format mai convert krna padega phle
